...
class JeevesKeyboardIME : InputMethodService() {
    private val TAG = "JeevesKeyboardIME"

    companion object {
        private var instance: JeevesKeyboardIME? = null

        fun getInstance(): JeevesKeyboardIME? = instance

        /**
         * Check if the JeevesKeyboardIME is currently active and available
         */
    ...
    override fun onCreate() {
        super.onCreate()
        instance = this
        Log.d(TAG, "JeevesKeyboardIME: onCreate() called")
    }
    ...
    override fun onDestroy() {
        Log.d(TAG, "JeevesKeyboardIME: onDestroy() called")
        instance = null
        super.onDestroy()
    }
}
